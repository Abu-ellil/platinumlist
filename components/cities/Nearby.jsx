...
const Nearby = ({ citiesData }) => {
    ...
    // Function to render a single city item
    const renderCityItem = (city, index) => (
        <div 
            ...
            tabIndex="-1" 
            role="option" 
            aria-describedby={`slick-slide${150 + index}`}
        >
                ...
                <div className="container2 padded clearfix">
                    ...
                    <div className="section__content">
                        ...
                        >
                            ...
                            >
                                <div aria-live="polite" className="slick-list draggable">
                                    <div 
                                        ...
                                        style={{opacity: 1, width: "1188px", transform: "translate3d(0px, 0px, 0px)"}}
                                        role="listbox"
                                    >
                                        {citiesData.map((city, index) => renderCityItem(city, index))}
                                    </div>
                                </div>
                            </div>
                            <a 
                            ...
                            <a 
                                href="javascript:void(0)"
                                className="item-slider__arrow item-slider__arrow--right slick-arrow slick-hidden"
                                data-switch-item-slider=""
                                data-ga4-click-item='{"event_name":"media_click","item":null,"type":"you_might_like","hierarchy":null,"id":null,"id_name":null,"interface_location":null,"status":null,"meta":null,"comment":null}'
                                aria-disabled="true" 
                                tabIndex="-1"
